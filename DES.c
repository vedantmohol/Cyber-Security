...
int main()
{
    ...
    row = to_digit(k1_temp[0], k1_temp[3]);
    col = to_digit(k1_temp[1], k1_temp[2]);
    ...
    row = to_digit(k1_temp[4], k1_temp[7]);
    col = to_digit(k1_temp[5], k1_temp[6]);
    ...
    row = to_digit(k2_temp[0], k2_temp[3]);
    col = to_digit(k2_temp[1], k2_temp[2]);
    ...
    row = to_digit(k2_temp[4], k2_temp[7]);
    col = to_digit(k2_temp[5], k2_temp[6]);
