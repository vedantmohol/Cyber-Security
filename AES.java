...
public class AES {
    ...
    private static final String[][] SBOX = { { "1001", "0100", "1010", "1011" }, { "1101", "0001", "1000", "0101" },
    ...
    private int gfMul(int a, int b) {
        ...
        while (b > 0) {
            ...
            if ((a & (1 << 4)) != 0)
                a = a ^ 0b10011; // XOR with irreducible polynomial with high term eliminated 1010010110100101
                                 // 1100001100111100
    ...
    public String encrypt(String plainText) {
        ...
        for (int i = 0; i < encryptionConstantMatrix.length; i++) {
            for (int j = 0; j < matrix.length; j++) {
                ...
                for (int k = 0; k < 2; k++) {
                    tempResults[k] = decimalToBinary(
                            gfMul(encryptionConstantMatrix[i][k], binaryToDecimal(matrix[k][j])), 4);
                }
        ...
        AES simplifiedAdvancedEncryptionStandard = new AES(
                key);
